...
import { signup, loginWithGitHub, PYTHON_API_BASE_URL } from "../../api";
...
export default function SignupForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setOtpError(err.message || "An error occurred during signup. Please try again.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <>
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0a0a0a] px-2 text-white/40">or sign up with</span>
            </div>
          </div>
