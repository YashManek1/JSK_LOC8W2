...
export class AdminController {
  ...
  @Post('mass-upload')
  @UseInterceptors(
    FilesInterceptor('pptxFiles', 200, {
      storage: diskStorage({
  ...
  eliminate(@Param('id') id: string) {
    return this.svc.eliminateEntry(id);
  }

  @Post('entries/:id/restore')
  restore(@Param('id') id: string) {
    return this.svc.restoreEntry(id);
  }

  @Post('entries/:id/requeue')
  requeue(@Param('id') id: string) {
    return this.svc.requeueEntry(id);
  }
  ...
  @Post('publish')
  publish() {
    return this.svc.publishLeaderboard();
  }

  @Post('rescore')
  rescore() {
    return this.svc.rescoreAll();
  }
}
